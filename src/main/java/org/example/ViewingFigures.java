...
//		chapterData.foreach(data -> System.out.println(data));
		...
		viewData
				...
				.mapToPair(tuple -> new Tuple2<>(tuple._1, (double) tuple._2._1 / tuple._2._2))
				.mapToPair(tuple -> {
					int score = 0;
					if (tuple._2 > 0.9) {
						score = 10;
					} else if (tuple._2 > 0.5) {
						score = 4;
					} else if (tuple._2 > 0.25)  {
						score = 2;
					}
...
//				.mapToPair(tuple -> {
//					int score = 0;
//					if ((double)(tuple._2._1 / tuple._2._2) > 0.9) {
//						score = tuple._2._1 * 10;
//					} else if ((double)(tuple._2._1 / tuple._2._2) > 0.5 && (double)(tuple._2._1 / tuple._2._2) <= 0.9) {
//						score = tuple._2._1 * 4;
//					} else if ((double)(tuple._2._1 / tuple._2._2) > 0.25 && (double)(tuple._2._1 / tuple._2._2) <= 0.5)  {
//						score = tuple._2._1 * 2;
//					}
//
//					return new Tuple2<>(tuple._1, score);
...
//		viewData.leftOuterJoin(chapterData).foreach(join -> System.out.println(join));

//		chapterData
//				.join(chapterData)
//						.foreach(join -> System.out.println(join));
